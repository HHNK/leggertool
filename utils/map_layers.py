    ...
    def add_layers_to_map(self):
        ...
        styled_layers = OrderedDict([
            ...
            ('gekozen legger', [
                ...
                LayerDefinition('gekozen onderhouds diepte [m]', 'hydroobjects_selected_legger', '', 'gekozen_diepte', 'geometry',
                                None, True),
                LayerDefinition('gekozen legger diepte [m]', 'hydroobjects_selected_legger', '', 'gekozen_hydraulische_diepte', 'geometry',
                                None, True),
            ...
            ('herverdelingcheck', [
                LayerDefinition('debiet 3di', 'hydroobject', 'debiet_3di', 'debiet_3di', 'geometry', 'min_max_line', False),
